"""
Example test run for relative binning
"""
...
likelihood = rel_bin_likeli.RelativeBinning(ifos, waveform_generator,
...
result = bilby.run_sampler(likelihood = likelihood, priors = priors,
                           ...
                           npoints = 2048, outdir = 'Outdir_relative_binning', 
                           label = 'relative_binning')
result.plot_corner()